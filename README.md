...
> Άνοιγμα αυτής της σελίδας στο [https://nikolfp.github.io/price_range/](https://nikolfp.github.io/price_range/)
...
* αναζήτηση για **https://github.com/nikolfp/price_range** και εισαγωγή
...
* επικολλήστε **https://github.com/nikolfp/price_range** και κάντε κλικ στην εισαγωγή
